...
public class KahveDunyasiCustomerServiceImpl extends BaseCustomerManager {
    private final CustomerCheckService customerCheckService;

    public KahveDunyasiCustomerServiceImpl(CustomerCheckService customerCheckService){
