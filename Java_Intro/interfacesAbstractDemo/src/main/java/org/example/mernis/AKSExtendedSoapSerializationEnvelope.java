...
class AKSSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class AKSExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(AKSDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new AKSStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static AKSDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static AKSDateTimeConverter dateTimeConverter = new AKSStandardDateTimeConverter();

    public AKSExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public AKSExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new AKSMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=AKSHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,AKSExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=AKSHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
