...
public class AKSKPSPublicSoap
{
    ...
    public AKSKPSPublicSoap(){}

    public AKSKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public AKSKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        AKSExtendedSoapSerializationEnvelope envelope= new AKSExtendedSoapSerializationEnvelope(AKSExtendedSoapSerializationEnvelope.VER11);
